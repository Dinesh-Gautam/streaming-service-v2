...
describe("PrismaUserRepository", () => {
  ...
  it("should save and retrieve a user", async () => {
    ...
    const credential = new UserCredential(user.id, "password123");
  ...
  it("should throw an error when saving a user with a duplicate email", async () => {
    ...
    const credential1 = new UserCredential(user1.id, "password123");
    ...
    const credential2 = new UserCredential(user2.id, "password456");
