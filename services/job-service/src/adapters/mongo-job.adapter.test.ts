...
describe('MongoJobRepository', () => {
  ...
  describe('updateTaskStatus', () => {
    it('should update a task status', async () => {
      ...
      await repository.updateTaskStatus(jobId, taskId, status);
    ...
    it('should update task status with progress', async () => {
      ...
      await repository.updateTaskStatus(jobId, taskId, status, progress);
    ...
    it('should update task status with an error message', async () => {
      const jobId = new ObjectId().toHexString();
      const taskId = 'task-123';
